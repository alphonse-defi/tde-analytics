                    ...
                    <tbody>
                      {topHoldings.map((t, i) => (
                        <tr key={i} style={{ borderBottom: `1px solid ${THEME.border.subtle}` }}>
                          ...
                          <td style={{ padding: '12px', textAlign: 'right', color: THEME.text.primary }}>{t.balance?.toLocaleString(undefined, { maximumFractionDigits: 4 })}</td>
                          <td style={{ padding: '12px', textAlign: 'right', color: '#10b981', fontWeight: '600' }}>{formatUSD(t.usd_value)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ) : <div style={{ padding: '20px', textAlign: 'center', color: THEME.text.muted }}>No tokens found</div>}
              </div>
            </>
          ) : <div style={{ textAlign: 'center', padding: '40px', color: THEME.text.muted }}>Failed to load wallet data</div>}
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ marginTop: '24px' }}>
      ...
      <div style={{
        ...
        <p style={{ color: THEME.text.muted, fontSize: '0.85rem', margin: 0 }}>
      ...
      {trackedWallets.length === 0 && (
        <div style={{
          ...
          <h3 style={{ color: THEME.text.primary, marginBottom: '8px' }}>No Wallets Tracked Yet</h3>
      ...
      <td style={{ padding: '12px 16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: THEME.text.muted }}>{token.name}</div>
          </div>
        </div>
      </td>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                <thead>
                  <tr style={{ 
                    ...
                    <th style={{ padding: '14px 16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>#</th>
                    <th style={{ padding: '14px 16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>TOKEN</th>
                    <th style={{ padding: '14px 16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>NETWORK</th>
                    <th style={{ padding: '14px 16px', textAlign: 'right', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>PRICE</th>
                    <th style={{ padding: '14px 16px', textAlign: 'right', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>24H %</th>
                    <th style={{ padding: '14px 16px', textAlign: 'right', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>MARKET CAP</th>
                    <th style={{ padding: '14px 16px', textAlign: 'right', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>24H VOLUME</th>
                    <th style={{ padding: '14px 16px', textAlign: 'right', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>TRACK</th>
                  </tr>
                </thead>
                <tbody>
...
export default function App() {
  ...
  useEffect(() => {
    if (!selectedToken?.address || selectedToken.chain === 'solana' || activeView !== 'tracker') return;
            ...
            {selectedToken && (
              <>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontSize: '0.75rem', color: THEME.text.muted, marginBottom: '4px' }}>
                      Next Snapshot In
                    </div>
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
                        <thead>
                          <tr style={{ 
                            ...
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>#</th>
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>WALLET</th>
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem', cursor: 'pointer' }} onClick={() => handleSort('balance')}>
                              BALANCE <SortIcon column="balance" />
                            </th>
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem', cursor: 'pointer' }} onClick={() => handleSort('usd')}>
                              USD VALUE <SortIcon column="usd" />
                            </th>
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem', cursor: 'pointer' }} onClick={() => handleSort('percentage')}>
                              % SUPPLY <SortIcon column="percentage" />
                            </th>
                            <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>TYPE</th>
                          </tr>
                        </thead>
                        <tbody>
                              ...
                              >
                                ...
                                <td style={{ padding: '12px 14px' }}>
                                  {change ? (
                                    ...
                                    <span style={{ color: THEME.text.muted, fontSize: '0.8rem' }}>—</span>
                                  )}
                                </td>
                          ...
                          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                            <thead>
                              <tr style={{ 
                                ...
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>TYPE</th>
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>WALLET</th>
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>DETAILS</th>
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>AMOUNT</th>
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>USD VALUE</th>
                                <th style={{ padding: '16px', textAlign: 'left', color: THEME.text.muted, fontWeight: '600', fontSize: '0.75rem' }}>TIME</th>
                              </tr>
                            </thead>
                            <tbody>
                                  ...
                                  >
                                    ...
                                    <td style={{ padding: '14px 16px' }}>
                                      {transfer.type === 'buy' || transfer.type === 'sell' ? (
                                        ...
                                        <span style={{ color: THEME.text.muted, fontSize: '0.75rem' }}>-</span>
                                      )}
                                    </td>
                                    <td style={{ padding: '14px 16px' }}>
                                    ...
                                    <td style={{ padding: '14px 16px' }}>
                                      <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                                        <a 
                                          ...
                                          target="_blank"
                                          rel="noopener noreferrer"
                                          style={{ color: THEME.text.muted, fontSize: '0.8rem', textDecoration: 'none' }}
                                        >
