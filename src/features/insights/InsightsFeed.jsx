...
const SEVERITY_CONFIG = {
  [SEVERITY.CRITICAL]: { bg: 'rgba(220, 38, 38, 0.08)', border: 'rgba(220, 38, 38, 0.2)', color: '#dc2626', label: 'CRITICAL', dot: '#dc2626' },
  [SEVERITY.WARNING]: { bg: 'rgba(217, 119, 6, 0.08)', border: 'rgba(217, 119, 6, 0.2)', color: '#d97706', label: 'WARNING', dot: '#d97706' },
  [SEVERITY.POSITIVE]: { bg: 'rgba(22, 163, 74, 0.08)', border: 'rgba(22, 163, 74, 0.2)', color: '#16a34a', label: 'BULLISH', dot: '#16a34a' },
  [SEVERITY.INFO]: { bg: 'rgba(37, 99, 235, 0.06)', border: 'rgba(37, 99, 235, 0.15)', color: '#2563eb', label: 'INFO', dot: '#2563eb' }
};
